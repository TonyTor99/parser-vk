...
3. Укажи URL для парсинга (по умолчанию `https://alpinbet.com/dispatch/id1631660353/pbd-1-fon`) и включи парсинг.

Что делает приложение:
- отслеживает вкладку **Активные**;
- ищет новые активные матчи (без дублей);
...
- `TARGET_DATA_URL` — URL страницы с данными для парсинга
...
- `PARSER_INTERVAL_SECONDS` — интервал проверки в секундах (минимум 10)
